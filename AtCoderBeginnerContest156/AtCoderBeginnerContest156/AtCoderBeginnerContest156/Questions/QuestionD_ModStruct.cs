...
{
    public class QuestionD_ModStruct : AtCoderQuestionBase
    {
        public override IEnumerable<object> Solve(TextReader inputStream)
        {
            ...
            var all = Modular.Pow(new Modular(2), n) - new Modular(1); // 「0本のとき」を除く

            var combinationA = Modular.Combination(n, a);
            var combinationB = Modular.Combination(n, b);

            yield return (all - combinationA - combinationB).Value;
        }
    }
