...
namespace AtCoderGrandContest046
{
    class Program
    {
...
namespace AtCoderGrandContest046.Numerics
{
    ...
    public readonly struct Modular : IEquatable<Modular>, IComparable<Modular>
    {
        ...
        public static void InitializeCombinationTable(int max = defaultMaxFactorial)
        {
            ...
            long fInv = (Modular.One / Factorial(max)).Value;
            FactorialInverseCache[max] = (int)fInv;
            for (int i = max - 1; i >= 0; i--)
            {
                fInv = (fInv * (i + 1)) % Mod;
                FactorialInverseCache[i] = (int)fInv;
            }
        }
...
namespace AtCoderGrandContest046.Algorithms
{
...
namespace AtCoderGrandContest046.Collections
{
...
namespace AtCoderGrandContest046.Graphs
{
...
namespace AtCoderGrandContest046.Extensions
{
