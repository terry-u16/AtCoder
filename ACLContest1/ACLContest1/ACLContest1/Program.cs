...
namespace ACLContest1.Numerics
{
...
namespace ACLContest1.Algorithms
{
...
namespace ACLContest1.Collections
{
            ...
            public long[,] GetDistances()
            {
                ...
                for (int k = 0; k < _graph.NodeCount; k++)
                {
                    for (int i = 0; i < _graph.NodeCount; i++)
                    {
                        ...
                        {
                            distances[i, j] = System.Math.Min(distances[i, j], distances[i, k] + distances[k, j]);
                        }
                    }
                }
