...
namespace Aising2020.Algorithms
{
...
namespace Aising2020.Collections
{
    ...
    public class PriorityQueue<T> : IEnumerable<T> where T : IComparable<T>
    {
        ...
        public PriorityQueue(bool descending, Comparison<T> comparison) 
        {
        ...
        private int Compare(T a, T b) => _reverseFactor * (_comparison != null ? _comparison(a, b) : a.CompareTo(b));
...
namespace Aising2020.Extensions
{
