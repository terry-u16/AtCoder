...
namespace AtCoderBeginnerContest180
{
    class Program
    {
...
namespace AtCoderBeginnerContest180.Numerics
{
    ...
    public readonly struct Modular : IEquatable<Modular>, IComparable<Modular>
    {
        ...
        {
            CheckNR(n, r);
            return Factorial(n) * new Modular(FactorialInverseCache[n - r]);
        }
...
namespace AtCoderBeginnerContest180.Algorithms
{
...
namespace AtCoderBeginnerContest180.Collections
{
...
namespace AtCoderBeginnerContest180.Graphs
{
