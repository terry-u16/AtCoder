...
namespace AtCoderBeginnerContest163
{
    class Program
    {
        static void Main(string[] args)
        {
            IAtCoderQuestion question = new QuestionEReview();    // 問題に合わせて書き換え
...
namespace AtCoderBeginnerContest163.Algorithms
{
...
namespace AtCoderBeginnerContest163.Collections
{
...
namespace AtCoderBeginnerContest163.Extensions
{
