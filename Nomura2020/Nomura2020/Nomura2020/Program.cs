...
namespace Nomura2020.Algorithms
{
...
namespace Nomura2020.Collections
{
    ...
    public class UnionFindTree
    {
        ...
        public int GetRootOf(int index) => _nodes[index].FindRoot().ID;
...
namespace Nomura2020.Extensions
{
