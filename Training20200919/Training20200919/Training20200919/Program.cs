...
namespace Training20200919.Questions
{
    ...
    public class IOManager : IDisposable
    {
        ...
        {
            int c;
            while (!IsValidChar(c = _reader.Read()) && !_reader.EndOfStream) { }
            return (char)c;
        }
...
namespace Training20200919.Numerics
{
...
namespace Training20200919.Algorithms
{
...
namespace Training20200919.Collections
{
...
namespace Training20200919.Graphs
{
